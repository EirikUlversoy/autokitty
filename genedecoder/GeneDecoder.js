...
function GeneDecoder(){
	...
	function setup(){
		...
		secretGeneNames["Secret_b"] = "b";
		secretGeneNames["Secret_c"] = "c";
		secretGeneNames["Secret_d"] = "d";
		secretGeneNames["Secret_e"] = "e";
		secretGeneNames["Secret_f"] = "f";
		secretGeneNames["Secret_g"] = "g";
		secretGeneNames["Secret_h"] = "h";
		secretGeneNames["Secret_i"] = "i";
		secretGeneNames["Secret_j"] = "j";
		secretGeneNames["Secret_k"] = "k";
		secretGeneNames["Secret_m"] = "m";
		secretGeneNames["Secret_n"] = "n";
		secretGeneNames["Secret_o"] = "o";
		secretGeneNames["Secret_p"] = "p";
		secretGeneNames["Secret_q"] = "q";
		secretGeneNames["Secret_r"] = "r";
		secretGeneNames["Secret_s"] = "s";
		secretGeneNames["Secret_t"] = "t";
		secretGeneNames["Secret_u"] = "u";
		secretGeneNames["Secret_v"] = "v";
		secretGeneNames["Secret_w"] = "w";

		unknownGeneNames["Unknown_1"] = "1";
		unknownGeneNames["Unknown_2"] = "2";
		unknownGeneNames["Unknown_3"] = "3";
		unknownGeneNames["Unknown_4"] = "4";
		unknownGeneNames["Unknown_5"] = "5";
		unknownGeneNames["Unknown_6"] = "6";
		unknownGeneNames["Unknown_7"] = "7";
		unknownGeneNames["Unknown_8"] = "8";
		unknownGeneNames["Unknown_9"] = "9";
		unknownGeneNames["Unknown_a"] = "a";
		unknownGeneNames["Unknown_b"] = "b";
		unknownGeneNames["Unknown_c"] = "c";
		unknownGeneNames["Unknown_d"] = "d";
		unknownGeneNames["Unknown_e"] = "e";
		unknownGeneNames["Unknown_f"] = "f";
		unknownGeneNames["Unknown_g"] = "g";
		unknownGeneNames["Unknown_h"] = "h";
		unknownGeneNames["Unknown_i"] = "i";
		unknownGeneNames["Unknown_j"] = "j";
		unknownGeneNames["Unknown_k"] = "k";
		unknownGeneNames["Unknown_m"] = "m";
		unknownGeneNames["Unknown_n"] = "n";
		unknownGeneNames["Unknown_o"] = "o";
		unknownGeneNames["Unknown_p"] = "p";
		unknownGeneNames["Unknown_q"] = "q";
		unknownGeneNames["Unknown_r"] = "r";
		unknownGeneNames["Unknown_s"] = "s";
		unknownGeneNames["Unknown_t"] = "t";
		unknownGeneNames["Unknown_u"] = "u";
		unknownGeneNames["Unknown_v"] = "v";
		unknownGeneNames["Unknown_w"] = "w";
	...
	self.allGeneGroups[geneGroupNames[2]] = environmentGeneNames;
	self.allGeneGroups[geneGroupNames[3]] = mouthGeneNames;
	self.allGeneGroups[geneGroupNames[4]] = wildGeneNames;
	self.allGeneGroups[geneGroupNames[5]] = colorTertiaryGeneNames;
	self.allGeneGroups[geneGroupNames[6]] = colorSecondaryGeneNames;
	self.allGeneGroups[geneGroupNames[7]] = colorPrimaryGeneNames;
	self.allGeneGroups[geneGroupNames[8]] = eyesGeneNames;
	self.allGeneGroups[geneGroupNames[9]] = colorEyesGeneNames;
	self.allGeneGroups[geneGroupNames[10]] = patternGeneNames;
	self.allGeneGroups[geneGroupNames[11]] = bodyGeneNames;
